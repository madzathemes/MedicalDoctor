...
if(!function_exists('aq_resize')) {
     ...
     */
    function aq_resize_url( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
    ...
    function aq_resize( $url, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        ...
        return '<img src="'.$aq_resize->process( $url, $width, $height, $crop, $single, $upscale ).'" height="'.$height.'" width="'.$width.'" alt=""/>';
    }
}
