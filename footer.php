...
if  (!empty($mt_homepage_bg_p_image['footer_bottom']) or !empty($mt_homepage_bg_p_image['footer_top']) ) { ?>

<footer id="footer">

    <?php if(!empty($mt_homepage_bg_p_image['footer_top'])) { if ($mt_homepage_bg_p_image['footer_top'] != '0') { function_footer_widget_areas(); echo '<div class="mt-subfooter-line"></div>'; } } ?>

    <?php if(!empty($mt_homepage_bg_p_image['footer_bottom'])) { if  ($mt_homepage_bg_p_image['footer_bottom'] != '0') { ?>
